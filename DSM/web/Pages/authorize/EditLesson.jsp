<%-- 
    Document   : EditLesson
    Created on : Oct 9, 2018, 11:50:09 PM
    Author     : Leonardo
--%>
            ...
            <div class='row'>
                ...
                <div class="btn-save">
                    <div class='row' style="display: flex; justify-content: space-between">
                        <button type='submit' name='saveLesson' vlaue="save" class=' space col s12 btn btn-large waves-effect indigo'>Salvar aula</button>
